...
class C3po:
    def __init__(self, language):
        if language not in ["en", "pt", "es", "tl"]:
            raise ValueError("Language not suported")
        ...
        self.message = {
            ...
            "yes": {"en": "y", "pt": "s", "es": "s", "tl": "H"},
            "no": {"en": "n", "pt": "n", "es": "n", "tl": "g"},
            "show_regs": {
    ...
    def presentation(self):
        print(
            "Hi, I'm C-3PO, human-cyborg relations, I'm fluent in over 6 million forms os communication."
        )
